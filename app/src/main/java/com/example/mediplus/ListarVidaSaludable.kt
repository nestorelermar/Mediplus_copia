...
class ListarVidaSaludable : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_listar_vida_saludable)

        val buttonMenu = findViewById<ImageView>(R.id.button_menu_puntos_vida_saludable)
